 ...
 */
package com.mycompany.getuserinputsaveinfileanddisplay;
...
public class jFormMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TextField4 = new javax.swing.JTextArea();
        ...
        TextField4.setRows(5);
        jScrollPane1.setViewportView(TextField4);
...
// TODO add your handling code here:
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (!tf1.isEmpty() && !tf2.isEmpty()  && !tf3.isEmpty()) {
            try {
                BufferedWriter bw = new BufferedWriter(new FileWriter("saveMe.txt", true));
                bw.write(tf1+"\n");
                bw.write(tf2+"\n");
                bw.write(tf3+"\n");
                bw.write("\n");
                ...
                JOptionPane.showMessageDialog(rootPane, "Error in saving the file");

            }
        }
        else{
            JOptionPane.showMessageDialog(rootPane, "Any Field is empty");
        }
    }//GEN-LAST:event_btnSaveActionPerformed

    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        //display all the data which is saved in file 
        
        //firstRead the file by using bufferedwriter
        
        try{
            BufferedReader br =new  BufferedReader(new FileReader("saveMe.txt"));
            String line;
            TextField4.setEditable(false);

            while((line = br.readLine()) != null){
                TextField4.append(line+"\n");
            }
            br.close();
        }catch(Exception e){
            e.printStackTrace();
            JOptionPane.showMessageDialog(rootPane, "Problem in Reading Data");
        }
    ...
    private javax.swing.JTextArea TextField4;
